...
import { getVehicle, listAssignmentsDetailed, listVehicleStock, type MedicalVehicle, type VehicleAssignmentDetailed, type VehicleStockUsage } from '../utils/medicalVehicleApi';
...
export default function Dashboard() {
  ...
  const patientsTreated = useMemo(() => stock.reduce((sum, r) => sum + (r.patients_treated ?? 0), 0), [stock]);
