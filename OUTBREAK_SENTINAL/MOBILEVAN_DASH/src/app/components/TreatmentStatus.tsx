...
import { listAssignmentsDetailed, listVehicleStock, type VehicleAssignmentDetailed, type VehicleStockUsage } from '../utils/medicalVehicleApi';
...
export default function TreatmentStatus() {
  ...
  const patientsTreated = useMemo(() => stock.reduce((s, e) => s + (e.patients_treated ?? 0), 0), [stock]);
